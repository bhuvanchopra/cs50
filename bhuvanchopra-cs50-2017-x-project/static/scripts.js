...
for (var h=0; h<allTextLines.length ;) {



var latlng = new google.maps.LatLng(allTextLines[h],allTextLines[h+1]);
    var marker = new google.maps.Marker({
        //position: {lat: 57.70887, lng: 11.97456},
        position: latlng,
        map: map,
        //label: "my place"
...
//var markerCluster = new MarkerClusterer(map, markers,{imagePath: "/static/"});
var markerCluster = new MarkerClusterer(map, markers, {imagePath: "/static/m"});
...
//var latlng = new google.maps.LatLng(allTextLines[0],allTextLines[1]);
